...
## 今のあなた
あなた自身の性質を、相手が「これ自分のことだ」と感じる具体的な描写で2〜3段落。「${shuku.catchy}」というタイプ呼称は本文に1回まで使ってよい。

## 今日の心の動き
今日の気分・心の動きと、内側で起きている変化を1〜2段落。

## 仕事と人間関係
仕事や日常の選び方、人との距離感、恋愛・友人関係での向き合い方を1〜2段落。

## 気をつけたいクセ
注意点を1段落。「${shuku.caution}」のニュアンスを織り込む。
...
## 今日のキーフレーズ
短い1文（40字以内、句点1つ）で締める。

[厳守事項]
- 全体で 1200〜1800 字程度。
- 見出しは上記6つだけ。「序章」「はじめに」「まとめ」「終わりに」などを追加しない。
